...
const (
	...
	defaultConfigVersion = "v2025.1.8"
	...
	// statsTimeout bounds WaitStats; a deferred publish only becomes ready when
	...
	// appear. Delivery from nsqd normally lands well inside a second.
...
// listener binds after the driver has pinged nsqd, so dialing it proves the
